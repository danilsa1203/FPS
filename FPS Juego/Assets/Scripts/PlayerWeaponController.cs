...
public class PlayerWeaponController : MonoBehaviour
{
    ...
    public Transform defaultParentPosition;
    ...
    {
        weaponParentSocket.position = defaultParentPosition.position;
        weaponParentSocket.rotation = defaultParentPosition.rotation;
